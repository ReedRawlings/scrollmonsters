...
async function main() {
  ...
  await page.evaluate(() => {
    window.__scollTest.setSave({unlockedStage: 10, recruits: ['striker'], upgrades: {strikerFollowup:1, power:1, health:3, autoTarget:1}, autoTargetEnabled:true});
    window.__scollTest.startStage(5);
  });
