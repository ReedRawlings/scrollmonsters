...
async function main() {
  ...
  await page.evaluate(() => {
    window.__scollTest.setSave({ unlockedStage: 10, recruits: ['striker', 'healer'], upgrades: { power: 3, speed: 3, multishot: 2, health: 3, strikerPower: 3, strikerSpeed: 2, healPower: 3, healSpeed: 2, autoTarget: 1 }, autoTargetEnabled: true });
    window.__scollTest.startStage(10);
  });
